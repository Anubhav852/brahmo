...
('N-G01','supra','HL-GLOBAL','CONSTRAINT','Warfarin-NSAID Interaction',
 'CRITICAL: Never prescribe NSAIDs to patients on Warfarin. Risk of life-threatening GI bleed. Alternative: Paracetamol for pain.',
 0.98,2,'ACTIVE',0.15,'{}',NULL),
('N-G02','supra','HL-GLOBAL','CONSTRAINT','Penicillin Allergy Cross-Reactivity',
 'Patients with penicillin allergy: 10% cross-reactivity with 1st-gen cephalosporins. Use azithromycin as first-line alternative.',
...
('N-G10','supra','HL-GLOBAL','FACT','Supra Formulary Preferred Brands',
 'Supra formulary: Paracetamol (Calpol/Dolo), Omeprazole (Omez), Amoxicillin (Mox), Metformin (Glycomet).',
...
('N-O01','supra','HL-05-ORTHO','CONSTRAINT','Post-Op Vitals Monitoring',
 'Post-operative vitals every 15 minutes for first 4 hours, then hourly for 24 hours. Include neurovascular check.',
 0.94,1,'ACTIVE',0.35,'{}','ortho'),
('N-O02','supra','HL-08-ORTHO-TKR','DECISION','Paracetamol First-Line Post-TKR',
 'Supra Ortho: Paracetamol 650mg QDS as first-line post-TKR pain. Escalation: Tramadol 50mg if VAS > 6. AVOID NSAIDs.',
 0.88,1,'ACTIVE',0.08,'{}','ortho'),
('N-O03','supra','HL-08-ORTHO-TKR','ANTI_PATTERN','Never Discharge TKR Under 48 Hours',
 'Do NOT discharge TKR patients before 48 hours post-op. Past incident: patient discharged at 36 hours developed DVT.',
 0.91,1,'ACTIVE',0.10,'{}','ortho'),
('N-O04','supra','HL-05-ORTHO','DECISION','Zimmer Implant Preference',
 'Supra Ortho uses Zimmer Biomet as preferred TKR implant. Alternative: Smith & Nephew for revision cases only.',
...
('N-O06','supra','HL-05-ORTHO','CONSTRAINT','DVT Prophylaxis Protocol',
 'ALL ortho surgical patients receive DVT prophylaxis: Enoxaparin 40mg SC daily starting 12 hours post-op.',
...
('N-O09','supra','HL-08-POST-TKR','CONSTRAINT','Post-TKR Physiotherapy Start',
 'Physiotherapy MUST begin within 24 hours of TKR. Day 1: ankle pumps, static quads. Day 2: CPM machine.',
 0.90,1,'ACTIVE',0.20,'{}','ortho'),
('N-O10','supra','HL-05-ORTHO','ANTI_PATTERN','Weight-Bearing Before X-Ray Confirmation',
 'NEVER allow weight-bearing on fractured limb before X-ray confirmation. Past incident: tibial fracture displacement.',
 0.89,1,'ACTIVE',0.15,'{}','ortho'),
('N-O11','supra','HL-05-ORTHO','DECISION','Ortho Department Budget Allocation 2026',
 'FY 2026 budget: 4.2 Cr. Implants: 45%, Staffing: 30%, Equipment: 15%, Training: 10%.',
 0.70,1,'ACTIVE',0.05,'{"MNPI"}','ortho'),
('N-O12','supra','HL-05-ORTHO','DECISION','Ortho Vendor Negotiation Strategy',
 'Renegotiate Zimmer contract July 2026. Target: 12% discount. Fallback: Smith & Nephew 15% below Zimmer.',
...
('N-O14','supra','HL-12-RAJAN','CONSTRAINT','Patient Rajan: Absolute NSAID Contraindication',
 'ABSOLUTE CONTRAINDICATION: No ibuprofen, no aspirin, no diclofenac for Rajan. Use Paracetamol ONLY.',
 0.99,1,'ACTIVE',0.01,'{}','ortho'),
('N-O15','supra','HL-10-ORTHO-W','DECISION','Ortho Night Shift Handover Protocol',
 'Night shift handover: 15-minute structured SBAR format. Include pending labs, new admissions, surgical list.',
...
('N-M01','supra','HL-05-MED','CONSTRAINT','Diabetic Fasting Protocol',
 'For diabetic patients fasting: adjust insulin timing, NOT dose. Monitor BG q4h. Break fast if BG < 70.',
...
('N-M04','supra','HL-12-PADMA','FACT','Patient Padma: DM Fasting Patterns',
 'Padma, 62F. Type 2 DM on Metformin 1000mg BD. Skip Glimepiride on fast days, continue Metformin with evening meal.',
 0.82,1,'ACTIVE',0.02,'{}','medicine'),
('N-M05','supra','HL-10-MED-W','DECISION','Medicine Ward IV Antibiotic Audit',
 'Weekly IV antibiotic audit. Target: 80% appropriate prescribing. Current: 74%.',
 0.68,1,'ACTIVE',0.20,'{}','medicine'),
('N-M06','supra','HL-05-MED','CONSTRAINT','Contrast Allergy Pre-Treatment',
 'Contrast allergy patients: pre-treat with Hydrocortisone 200mg IV + Chlorpheniramine 10mg IV, 1 hour before procedure.',
 0.88,1,'ACTIVE',0.35,'{}','medicine'),
('N-M07','supra','HL-05-MED','FACT','Medicine Department Specialty Clinics',
 'DM clinic (Mon/Wed), Hypertension clinic (Tue/Thu), Respiratory clinic (Fri). Each: 2 consultants, 1 registrar.',
 0.45,1,'ACTIVE',0.50,'{}','medicine'),
('N-M08','supra','HL-05-MED','DECISION','Sepsis Protocol v2 2024 (SUPERSEDED)',
 'OLD: Supra Sepsis Bundle v2 (2024). SUPERSEDED by v3 which tightened lactate window to 1 hour.',
...
('N-C03','supra','HL-05-CARDIO','ANTI_PATTERN','Discharge Without ECHO After First MI',
 'NEVER discharge first MI patient without echocardiography. Past incident: patient returned with CHF.',
 0.93,1,'ACTIVE',0.15,'{}','cardiology'),
('N-C04','supra','HL-05-CARDIO','FACT','Cardiology Research Trial: ATOM-2026',
 'Ongoing trial: ATOM-2026. 50 patients enrolled. Comparing Atorvastatin 40mg vs 80mg post-MI. CONFIDENTIAL.',
 0.60,1,'ACTIVE',0.05,'{"MNPI","CONFIDENTIAL"}','cardiology'),
('N-C05','supra','HL-05-CARDIO','DECISION','Dual Antiplatelet Duration Post-Stent',
 'DAPT for 12 months post-DES. High bleeding risk: 6 months. Ultra-high ischemic risk: 36 months.',
...
('N-P02','supra','HL-10-PAEDS-W','DECISION','Paeds Ward Visiting Hours Extension',
 'Paeds Ward: parents allowed 24/7. One parent can stay overnight. Improved satisfaction from 72% to 94%.',
 0.60,1,'ACTIVE',0.15,'{}','paediatrics'),
('N-P03','supra','HL-05-PAEDS','ANTI_PATTERN','Penicillin in Known Allergy Child',
 'CRITICAL: Patient Aadhya (3.5F) has documented penicillin allergy (anaphylaxis). Use azithromycin.',
...
('N-A01','supra','HL-01','DECISION','Hospital Expansion Plan 2026-2028',
 'Board-approved: 80 additional beds by Q4 2027. New Oncology wing (40 beds), ICU expansion (20 beds). CONFIDENTIAL.',
 0.80,1,'ACTIVE',0.02,'{"MNPI","CONFIDENTIAL"}',NULL),
('N-A02','supra','HL-01','DECISION','Staff Salary Restructuring 2026',
 'HR approved: 12% salary increase for nurses (July 2026), 8% for technicians. Board resolution #2026-014.',
 0.75,1,'ACTIVE',0.01,'{"MNPI","CONFIDENTIAL"}',NULL),
('N-A03','supra','HL-03-ADMIN','FACT','Hospital Accreditation Status',
 'NABH accreditation valid until March 2027. Gap areas: medication error reporting, hand hygiene compliance.',
 0.70,1,'ACTIVE',0.20,'{}',NULL),
('N-A04','supra','HL-01','CONSTRAINT','Legal Case: Rajan Medico-Legal Hold',
 'LEGAL HOLD: All records related to patient Rajan under medico-legal hold. NO modification or deletion.',
...
('N-D02','supra','HL-05-MED','FACT','Paracetamol Mechanism of Action',
 'Paracetamol is an analgesic and antipyretic. Inhibits prostaglandin synthesis in CNS. Max 4g/day adult.',
...
('N-D03','supra','HL-GLOBAL','FACT','Normal Vital Sign Ranges Adult',
 ...
 0.30,2,'ACTIVE',0.98,'{}',NULL),
('N-D04','supra','HL-05-ORTHO','FACT','What is Deep Vein Thrombosis',
 'DVT is a blood clot in a deep vein, usually in the legs. Risk factors: surgery, immobility, cancer.',
 0.35,1,'ACTIVE',0.93,'{}','ortho'),
('N-D05','supra','HL-05-MED','FACT','What is Type 2 Diabetes Mellitus',
 'Type 2 diabetes is a chronic condition where the body becomes resistant to insulin. Risk: obesity, sedentary lifestyle.',
